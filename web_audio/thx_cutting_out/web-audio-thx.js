...
(function(root) {
	...
	function WebAudioTHX(audioContext, params) {
		...
		var oscillators = [];
		var numberOfOscillators = params.numberOfOscillators !== undefined ? params.numberOfOscillators : 30;
		var soundLength = params.soundLength !== undefined ? params.soundLength : 26;
	...
	if(typeof define === 'function' && define.amd) {
		define(function() { return WebAudioTHX; });
	} else if(typeof module !== 'undefined' && module.exports) {
		module.exports = WebAudioTHX;
	} else {
		root.WebAudioTHX = WebAudioTHX;
	}
